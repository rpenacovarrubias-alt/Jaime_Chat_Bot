...
(function () {
  ...
  function injectCSS() {
    ...
    style.textContent = [
      ...
      '.j-foot-social{display:flex;gap:12px;}',
      '.j-foot-social a{color:#c6c4df;transition:color .2s;}',
      '.j-foot-social a:hover{color:#7af7e8;}',
      '.j-site-footer h5{color:#fff;font-family:"Plus Jakarta Sans",sans-serif;font-size:.75rem;letter-spacing:.1em;text-transform:uppercase;margin:0 0 14px;}',
      '.j-foot-contact{list-style:none;padding:0;margin:0;display:grid;gap:9px;}',
      '.j-foot-contact li{font-size:.86rem;color:#c6c4df;}',
      '.j-foot-contact a{color:#c6c4df;text-decoration:none;transition:color .2s;}',
      '.j-foot-contact a:hover{color:#7af7e8;}',
      '.j-foot-bottom{display:flex;justify-content:space-between;align-items:center;padding-top:20px;font-size:.8rem;color:#a8a6bf;flex-wrap:wrap;gap:10px;}',
      '@media(max-width:640px){.j-foot-grid{grid-template-columns:1fr;}}',
    ].join('');
    document.head.appendChild(style);

    if (!document.getElementById('j-fraunces-font')) {
      var fontLink = document.createElement('link');
      fontLink.id = 'j-fraunces-font';
      fontLink.rel = 'stylesheet';
      fontLink.href = 'https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,600&display=swap';
      document.head.appendChild(fontLink);
    }
  }

  // ── Site footer (Hospitalidad Digital / Coanfitriones México) ────────────
  function buildSiteFooter() {
    var year = new Date().getFullYear();
    return '<footer class="j-site-footer"><div class="j-foot-wrap">' +
      '<div class="j-foot-grid">' +
        '<div>' +
          '<div class="j-foot-brand">' +
            '<img src="/assets/img/logo-hospitalidad-digital.png" alt="Hospitalidad Digital" style="width:34px;height:34px;object-fit:contain;">' +
            '<span>Hospitalidad Digital<small>Coanfitriones México</small></span>' +
          '</div>' +
          '<p class="j-foot-about">Jaime es el chatbot de atención a huéspedes para hoteles, parte del ecosistema de productos de Hospitalidad Digital.</p>' +
          '<div class="j-foot-social">' +
            '<a href="https://www.facebook.com/coanfitrionesmexico" target="_blank" rel="noopener" aria-label="Facebook"><svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor"><path d="M14 9h3V6h-3c-1.7 0-3 1.3-3 3v2H9v3h2v6h3v-6h2.5l.5-3H14V9z"/></svg></a>' +
            '<a href="https://www.instagram.com/coanfitriones_mexico" target="_blank" rel="noopener" aria-label="Instagram"><svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.2c3.2 0 3.6 0 4.9.1 1.2.1 2 .3 2.4.5.6.2 1 .5 1.5 1 .4.4.7.9 1 1.5.2.4.4 1.2.5 2.4.1 1.3.1 1.7.1 4.9s0 3.6-.1 4.9c-.1 1.2-.3 2-.5 2.4-.2.6-.5 1-1 1.5-.4.4-.9.7-1.5 1-.4.2-1.2.4-2.4.5-1.3.1-1.7.1-4.9.1s-3.6 0-4.9-.1c-1.2-.1-2-.3-2.4-.5-.6-.2-1-.5-1.5-1-.4-.4-.7-.9-1-1.5-.2-.4-.4-1.2-.5-2.4C2.2 15.6 2.2 15.2 2.2 12s0-3.6.1-4.9c.1-1.2.3-2 .5-2.4.2-.6.5-1 1-1.5.4-.4.9-.7 1.5-1 .4-.2 1.2-.4 2.4-.5C8.4 2.2 8.8 2.2 12 2.2zm0 1.8c-3.1 0-3.5 0-4.7.1-1 .1-1.6.2-1.9.4-.5.2-.8.4-1.2.7-.3.3-.5.6-.7 1.2-.2.3-.3.9-.4 1.9-.1 1.2-.1 1.6-.1 4.7s0 3.5.1 4.7c.1 1 .2 1.6.4 1.9.2.5.4.8.7 1.2.3.3.6.5 1.2.7.3.2.9.3 1.9.4 1.2.1 1.6.1 4.7.1s3.5 0 4.7-.1c1-.1 1.6-.2 1.9-.4.5-.2.8-.4 1.2-.7.3-.3.5-.6.7-1.2.2-.3.3-.9.4-1.9.1-1.2.1-1.6.1-4.7s0-3.5-.1-4.7c-.1-1-.2-1.6-.4-1.9-.2-.5-.4-.8-.7-1.2-.3-.3-.6-.5-1.2-.7-.3-.2-.9-.3-1.9-.4-1.2-.1-1.6-.1-4.7-.1zm0 3.5a4.5 4.5 0 1 1 0 9 4.5 4.5 0 0 1 0-9zm0 1.8a2.7 2.7 0 1 0 0 5.4 2.7 2.7 0 0 0 0-5.4zm5.7-2a1 1 0 1 1 0 2.1 1 1 0 0 1 0-2.1z"/></svg></a>' +
            '<a href="https://www.tiktok.com/@coanfitrionesmexico" target="_blank" rel="noopener" aria-label="TikTok"><svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor"><path d="M16.6 5.8c-1-.7-1.6-1.8-1.7-3H12.6v12.3c0 1.3-1.1 2.4-2.4 2.4-1.3 0-2.4-1.1-2.4-2.4 0-1.3 1.1-2.4 2.4-2.4.3 0 .5 0 .8.1V9.9c-.3 0-.5-.1-.8-.1-2.8 0-5.1 2.3-5.1 5.1 0 2.8 2.3 5.1 5.1 5.1 2.8 0 5.1-2.3 5.1-5.1V9.1c1 .7 2.3 1.2 3.6 1.2V7.9c-.9 0-1.7-.3-2.3-.7z"/></svg></a>' +
            '<a href="https://bsky.app/profile/hospitalidadigital.bsky.social" target="_blank" rel="noopener" aria-label="Bluesky"><svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor"><path d="M12 10.8C10.5 7.9 7.9 5.1 5.4 3.4 4.9 3 4.2 3.4 4.2 4v9.1c0 .5.4.9.8 1 1.9.4 3.7 1.2 5.1 2.6-1.3-.4-2.7-.5-4-.1-.3.1-.4.5-.1.7 2 1.4 4.4 1.9 6-.6.2-.3.3-.6.3-.7 0 .1.1.4.3.7 1.6 2.5 4 2 6 .6.3-.2.2-.6-.1-.7-1.3-.4-2.7-.3-4 .1 1.4-1.4 3.2-2.2 5.1-2.6.4-.1.8-.5.8-1V4c0-.6-.7-1-1.2-.6-2.5 1.7-5.1 4.5-6.6 7.4z"/></svg></a>' +
        ...
        '<div>' +
          ...
          '<ul class="j-foot-contact">' +
            ...
            '<li><a href="mailto:hola@coanfitrionesmexico.com.mx">hola@coanfitrionesmexico.com.mx</a></li>' +
            '<li><a href="https://wa.me/524421851478" target="_blank" rel="noopener">WhatsApp: 442 185 1478</a></li>' +
            '<li><a href="https://coanfitrionesmexico.com.mx/" target="_blank" rel="noopener">coanfitrionesmexico.com.mx</a></li>' +
          '</ul>' +
        '</div>' +
      '</div>' +
      '<div class="j-foot-bottom">' +
        '<span>© ' + year + ' Hospitalidad Digital · Todos los derechos reservados.</span>' +
        '<span><a href="#">Política de privacidad</a> · <a href="#">Términos de uso</a></span>' +
      '</div>' +
    '</div></footer>';
  }
  ...
  function inject() {
    ...
    // Site footer (Hospitalidad Digital)
    var footerEl = document.createElement('div');
    footerEl.innerHTML = buildSiteFooter();
    content.appendChild(footerEl.firstElementChild);
